...
def test_transactional_licence_form(page: Page):
    ...
    page.get_by_label("Country").fill("Chi")
    ...
    expect(get_review_row(page, "Address line 1")).to_have_text("123 Organisation Road")
    expect(get_review_row(page, "Address line 2 (optional)")).to_have_text("Organisation Street")
    expect(get_review_row(page, "Town or city")).to_have_text("Organisationville")
    expect(get_review_row(page, "County (optional)")).to_have_text("Organisationshire")
    expect(get_review_row(page, "Country")).to_have_text("Chile")
