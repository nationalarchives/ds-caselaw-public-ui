...
MIGRATION_MODULES = {"sites": "ds_judgements_public_ui.contrib.sites.migrations"}
...
ADMINS = [("""Laura Porter""", "laura@dxw.com")]
...
TRANSACTIONAL_LICENCE_FROM_EMAIL = env("TRANSACTIONAL_LICENCE_FROM_EMAIL")
TRANSACTIONAL_LICENCE_DELIVERY_EMAIL = env("TRANSACTIONAL_LICENCE_DELIVERY_EMAIL")
TRANSACTIONAL_LICENCE_EMAIL_SUBJECT = env("TRANSACTIONAL_LICENCE_EMAIL_SUBJECT")
SES_SMTP_USERNAME = env("SES_SMTP_USERNAME")
SES_SMTP_PASSWORD = env("SES_SMTP_PASSWORD")
SES_SMTP_SERVER = env("SES_SMTP_SERVER")
SES_SMTP_PORT = env("SES_SMTP_PORT")
