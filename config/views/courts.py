...
class CourtsTribunalsListView(TemplateViewWithContext):
    ...
    def get_context_data(self, **kwargs):
        ...
        grouped_courts = [
            self.decorate_court_group(group) for group in courts.get_grouped_show_in_public_directory_courts()
        ]
        grouped_tribunals = [
            self.decorate_court_group(group) for group in courts.get_grouped_show_in_public_directory_tribunals()
        ]
