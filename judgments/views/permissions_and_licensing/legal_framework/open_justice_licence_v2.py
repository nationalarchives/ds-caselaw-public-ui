...
class OpenJusticeLicenceV2View(TemplateViewWithContext):
    template_engine = "jinja"
    template_name = "pages/permissions_and_licensing/legal_framework/open_justice_licence_v2.jinja"

    page_title = "Open Justice Licence v2.0"
    page_canonical_url_name = "open_justice_licence_v2"
