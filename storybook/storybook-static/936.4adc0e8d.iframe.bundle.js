...
(self.webpackChunkstorybook = self.webpackChunkstorybook || []).push([
    [936],
    {
        "./node_modules/@storybook/blocks/dist/Color-YHDXOIA2.mjs": function (
            ...
            var _chunk_2PTXLE6R_mjs__WEBPACK_IMPORTED_MODULE_0__ =
                    __webpack_require__(
                ...
                storybook_internal_components__WEBPACK_IMPORTED_MODULE_2__ =
                    __webpack_require__(
                ...
                _chunk_2PTXLE6R_mjs__WEBPACK_IMPORTED_MODULE_0__.P$)({
                    ...
                    "../../node_modules/color-convert/conversions.js"(
                        ...
                        for (let model of Object.keys(convert2)) {
                            if (!("channels" in convert2[model]))
                                throw new Error(
                                    "missing channels property: " + model,
                                );
                            ...
                            if (
                                convert2[model].labels.length !==
                                convert2[model].channels
                            )
                                throw new Error(
                                    "channel and label counts mismatch: " +
                                        model,
                                );
                            let { channels: channels, labels: labels } =
                                convert2[model];
                        ...
                        ((convert2.rgb.hsl = function (rgb) {
                            ...
                            (convert2.hsv.ansi16 = function (args) {
                                return convert2.rgb.ansi16(
                                    convert2.hsv.rgb(args),
                                    args[2],
                                );
                            }),
                    ...
                    "../../node_modules/color-convert/route.js"(
                        ...
                        function deriveBFS(fromModel) {
                            ...
                            for (
                                ...
                                let current = queue.pop(),
                                    adjacents = Object.keys(
                                        conversions[current],
                                    );
                                for (
                                    let len = adjacents.length, i2 = 0;
                                    i2 < len;
                                    i2++
                                ) {
                        ...
                        function wrapConversion(toModel, graph) {
                            let path = [graph[toModel].parent, toModel],
                                fn =
                                    conversions[graph[toModel].parent][toModel],
                                cur = graph[toModel].parent;
                            for (; graph[cur].parent; )
                                (path.unshift(graph[cur].parent),
                                    (fn = link(
                                        conversions[graph[cur].parent][cur],
                                        fn,
                                    )),
                        ...
                        (Object.keys(conversions).forEach((fromModel) => {
                            ...
                            Object.keys(routes).forEach((toModel) => {
                                ...
                                ((convert2[fromModel][toModel] =
                                    ...
                                    (convert2[fromModel][toModel].raw =
                                        (function wrapRaw(fn) {
                                            let wrappedFn = function (...args) {
                                                let arg0 = args[0];
                                                return null == arg0
                ...
                _chunk_2PTXLE6R_mjs__WEBPACK_IMPORTED_MODULE_0__.f1)(
            ...
            function i(e2) {
                var t2 = (0, react__WEBPACK_IMPORTED_MODULE_1__.useRef)(e2),
                    n2 = (0, react__WEBPACK_IMPORTED_MODULE_1__.useRef)(
                        function (e3) {
            ...
            var s = function (e2, r2, t2) {
                ...
                d = function (e2, r2, t2) {
                    ...
                    return {
                        left: s(
                            (o2.pageX - (n2.left + v(e2).pageXOffset)) /
                                n2.width,
                        ),
                        top: s(
                            (o2.pageY - (n2.top + v(e2).pageYOffset)) /
                                n2.height,
                        ),
                    };
                },
                ...
                m = react__WEBPACK_IMPORTED_MODULE_1__.memo(function (o2) {
                    var a2 = o2.onMove,
                        l2 = o2.onKey,
                        s2 = c(o2, ["onMove", "onKey"]),
                        m2 = (0, react__WEBPACK_IMPORTED_MODULE_1__.useRef)(
                            null,
                        ),
                        g2 = i(a2),
                        p2 = i(l2),
                        b2 = (0, react__WEBPACK_IMPORTED_MODULE_1__.useRef)(
                            null,
                        ),
                        _2 = (0, react__WEBPACK_IMPORTED_MODULE_1__.useRef)(!1),
                        x2 = (0, react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(
                            function () {
                                var e2 = function (e3) {
                                        (h(e3),
                                            (f(e3)
                                                ? e3.touches.length > 0
                                                : e3.buttons > 0) && m2.current
                                                ? g2(
                                                      d(
                                                          m2.current,
                                                          e3,
                ...
                S = react__WEBPACK_IMPORTED_MODULE_1__.memo(function (r2) {
                    var t2 = r2.hue,
                        n2 = r2.onChange,
                ...
                T = react__WEBPACK_IMPORTED_MODULE_1__.memo(function (r2) {
                    var t2 = r2.hsva,
                        n2 = r2.onChange,
                        o2 = {
                            backgroundColor: q({
            ...
            function Y(e2, t2, l2) {
                var u2 = i(l2),
                    c2 = (0, react__WEBPACK_IMPORTED_MODULE_1__.useState)(
                        function () {
                            return e2.toHsva(t2);
                        },
                    ),
                    s2 = c2[0],
                    f2 = c2[1],
                    v2 = (0, react__WEBPACK_IMPORTED_MODULE_1__.useRef)({
                        color: t2,
                        hsva: s2,
                    });
                ((0, react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(
                    ...
                    (0, react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(
                        function () {
                            ...
                            F(s2, v2.current.hsva) ||
                                ...
                                ((v2.current = { hsva: s2, color: r2 }),
                                u2(r2));
                        },
                        [s2, e2, u2],
                    ));
                var d2 = (0, react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(
                    function (e3) {
                        f2(function (r2) {
            ...
            var ColorSpace2,
                ...
                U = function (t2) {
                    var n2 = t2.className,
                        ...
                        f2 = (0, react__WEBPACK_IMPORTED_MODULE_1__.useRef)(
                            null,
                        );
                    Q(f2);
                    var v2 = Y(o2, l2, i2),
                    ...
                    return react__WEBPACK_IMPORTED_MODULE_1__.createElement(
                        ...
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(T, {
                            hsva: d2,
                            onChange: h2,
                        }),
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(S, {
                            hue: d2.h,
                            onChange: h2,
                ...
                re = function (t2) {
                    ...
                    return react__WEBPACK_IMPORTED_MODULE_1__.createElement(
                        ...
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(ee, {
                            hsva: d2,
                            onChange: h2,
                            className: "react-colorful__last-control",
                        }),
                ...
                Wrapper =
                    storybook_internal_theming__WEBPACK_IMPORTED_MODULE_3__.I4.div(
                        {
                            position: "relative",
                            maxWidth: 250,
                ...
                PickerTooltip = (0,
                storybook_internal_theming__WEBPACK_IMPORTED_MODULE_3__.I4)(
                    storybook_internal_components__WEBPACK_IMPORTED_MODULE_2__.kR,
                )({
                    position: "absolute",
                    zIndex: 1,
                    top: 4,
                ...
                Note = (0,
                storybook_internal_theming__WEBPACK_IMPORTED_MODULE_3__.I4)(
                    storybook_internal_components__WEBPACK_IMPORTED_MODULE_2__._,
                )(({ theme: theme }) => ({
                ...
                Swatch = ({ value: value, style: style, ...props }) => {
                    ...
                    let realValue = (0,
                        ...
                        react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(
                            (update) => {
                                ...
                                (setValue(v2),
                                    "" === v2 &&
                                        (setColor(void 0), onChange(void 0)),
                                    parsed &&
                                        (setColor(parsed),
                ...
                ColorControl = ({
                    ...
                    let debouncedOnChange = (0,
                        react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(
                            (0,
                            _chunk_2PTXLE6R_mjs__WEBPACK_IMPORTED_MODULE_0__.sg)(
                                onChange,
                                200,
                            ),
                            [onChange],
                    ...
                    return react__WEBPACK_IMPORTED_MODULE_1__.createElement(
                        ...
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(
                            ...
                            {
                                id: (0,
                                _chunk_2PTXLE6R_mjs__WEBPACK_IMPORTED_MODULE_0__.ZA)(
                                    name,
                                ),
                                value: value,
