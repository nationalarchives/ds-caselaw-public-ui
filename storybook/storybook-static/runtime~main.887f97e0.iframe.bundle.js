!(function () {
    ...
    ((__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.u = function (chunkId) {
            return (
                (399 === chunkId ? "button-stories" : chunkId) +
                "." +
                {
                    364: "a28d94c8",
                    399: "bf436f5b",
        ...
        (__webpack_require__.l = function (url, done, key, chunkId) {
            if (inProgress[url]) inProgress[url].push(done);
                ...
                if (void 0 !== key)
                    for (
                        ...
                        if (
                            ...
                            s.getAttribute("data-webpack") == "storybook:" + key
                        ) {
                            script = s;
                            break;
                        }
                ...
                (script ||
                    ...
                    script.setAttribute("data-webpack", "storybook:" + key),
                    (script.src = url)),
                    (inProgress[url] = [done]));
        ...
        (function () {
            ...
            var webpackJsonpCallback = function (
                ...
                chunkLoadingGlobal = (self.webpackChunkstorybook =
                    self.webpackChunkstorybook || []);
